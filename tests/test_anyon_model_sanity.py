...
from braiding_generators.fib_multi_qudits import sigma as sigma_fib
from braiding_generators.fib_multi_qudits import L as L_fib, B as B_fib
from braiding_generators.fib_qudit import F as F_fib, B as B_fib_qudit
from braiding_generators.fib_multi_qudits import S as K_fib

from braiding_generators.ising_multi_qudits import sigma as sigma_ising
from braiding_generators.ising_multi_qudits import L as L_ising, B as B_ising
from braiding_generators.ising_qudit import F as F_ising, B as B_ising_qudit
from braiding_generators.ising_multi_qudits import S as K_ising
...
def test_K_matrix_fib_and_ising():
    # Check K (knitting) matrix mapping for both Fibonacci and Ising models for q=3
    q = 3
    a = [1 for _ in range(q + 2)]

    # Fibonacci
    K_matrix = fib_model.compute_knitting_matrix(q)
    new_K = lambda jm, jmo, jmoo, jmo_, h, i_, i, jj_, jj: K_matrix[tuple(a + [h, jmoo, jm, jmo, i] + jj + [jmo_, i_] + jj_)]
