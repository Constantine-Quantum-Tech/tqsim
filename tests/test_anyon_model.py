...
class TestAnyonModel:
    ...
    def test_braiding_matrix_shape(self, fibonacci_model):
        ...
        assert B.shape == expected_shape, f"Expected shape {expected_shape}, got {B.shape}"
    ...
    def test_L_matrix_computation_q1(self, fibonacci_model):
        ...
        expected_shape = (2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
        assert L1.shape == expected_shape, f"Expected shape {expected_shape}, got {L1.shape}"
    ...
    def test_knitting_matrix_computation_q1(self, fibonacci_model):
        ...
        expected_shape = (2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
    ...
    def test_check_rule_method(self, fibonacci_model):
        ...
        assert fibonacci_model.check_rule(np.array([0]), np.array([0]), np.array([0]))[0]
        assert fibonacci_model.check_rule(np.array([0]), np.array([1]), np.array([1]))[0]
        assert fibonacci_model.check_rule(np.array([1]), np.array([0]), np.array([1]))[0]
        assert fibonacci_model.check_rule(np.array([1]), np.array([1]), np.array([0]))[0]
        assert fibonacci_model.check_rule(np.array([1]), np.array([1]), np.array([1]))[0]
        
        # Test invalid fusion rules
        assert not fibonacci_model.check_rule(np.array([0]), np.array([0]), np.array([1]))[0]
        assert not fibonacci_model.check_rule(np.array([0]), np.array([1]), np.array([0]))[0]
        assert not fibonacci_model.check_rule(np.array([1]), np.array([0]), np.array([0]))[0]
