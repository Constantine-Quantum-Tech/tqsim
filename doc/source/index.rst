.. TQSim documentation master file, created by
   sphinx-quickstart on Thu May 25 11:49:23 2023.
...
.. image:: https://raw.githubusercontent.com/Constantine-Quantum-Tech/tqsim/main/images/cqtech_logo.png
   :align: right
   :width: 70
   :alt: CQTech

TQSim stands for Topological Quantum Simulator. It is an open-source library for simulating 
topological quantum computers based on Fibonacci anyons.
...
.. toctree::
   ...
   frontend/anyonic_circuit
   frontend/drawer_anyon
   frontend/utils
...
.. toctree::
   ...
   backend/basis_generator
   backend/operator_generator
...
.. image:: https://i.ibb.co/3z9pFmQ/example.png
   :alt: Circuit Output
...
.. image:: https://i.ibb.co/5kDVWgf/example-hadamard.png
   :alt: Circuit Output
...
If you have used TQSim in your work, please use the `BibTeX file <citation.bib>`_ to cite the authors.
